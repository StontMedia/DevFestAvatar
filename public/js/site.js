...
$(document).ready(function () {
    ...
    function DownloadColor() {
        ...
        general_to_crop.cropme('crop', {
            ...
            var finalImageLength = 64.62962962962963 / 100 * ImageLength;

            var outputX = 17.16046296296296 / 100 * ImageLength;
            var outputY = 11.2025 / 100 * ImageLength;

            mergeImages([
                { src: output, x: outputX, y: outputY, height: finalImageLength, width: finalImageLength },
                { src: template, x: 0, y: 0, height: ImageLength, width: ImageLength }
            ], {
                width: ImageLength,
                height: ImageLength
            }).then(b64 => {
